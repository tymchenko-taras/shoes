...
INSERT INTO `user` (`user_id`, `user_group_id`, `username`, `password`, `salt`,`firstname`,`lastname`,`email`,`ip`,`status`, `date_added`) VALUES
(
  1,
  1,
  'admin',
  '7a176ffa4b8cd4771ca4540169a1b5cdef874de9',
  'IlaIKFGTJ',
  'John',
  'Doe',
  'noemail@email.com',
